...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "b", function () awful.spawn("chbg.sh") end,
...
-- Autostart
awful.spawn.with_shell("xsetroot -cursor_name letf_ptr")
awful.spawn.with_shell("picom -f &")
--awful.spawn.with_shell("pasystray")
--awful.spawn.with_shell("pavucontrol")
awful.spawn.with_shell("nm-applet")
awful.spawn.with_shell("feh --bg-fill --randomize ~/.tools/bg/*")
